...
public class ThreadPoolTest {
  ...
  public static void main(String[] args) {
    ...
    ThreadPool4 threadPool = new ThreadPool4(numThreads);
...
class ThreadPool4 extends ThreadGroup {
   ...
   */
  public ThreadPool4(int numThreads) {
  ...
  private class PooledThread extends Thread {
    ...
    public PooledThread() {
      super(ThreadPool4.this, "PooledThread-" + (threadID++));
    }
